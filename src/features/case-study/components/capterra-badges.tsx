...
const CAPTERRA_BADGES: readonly CapterraBadge[] = [
  {
    src: "/portfolio/assets/img/capterra/ease-of-use-2025.png",
    alt: "Selo Capterra Ease of Use 2025",
  },
  {
    src: "/portfolio/assets/img/capterra/best-value-2025.png",
  ...
  <div className="mx-auto max-w-[700px] px-12">
    <div className="flex justify-center gap-4">
      {CAPTERRA_BADGES.map((badge) => (
        <img key={badge.src} src={badge.src} alt={badge.alt} className="h-24 w-auto" />
      ))}
    </div>
  </div>
);
